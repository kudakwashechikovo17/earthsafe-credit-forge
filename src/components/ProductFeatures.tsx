      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
          {features.map((feature, index) => (
            <Card 
              key={index} 
              className="p-8 card-hover border-earth-200 bg-white/80 backdrop-blur-sm animate-scale-in"
        ...
        <div className="mt-20 max-w-6xl mx-auto">
          <div className="bg-white rounded-2xl shadow-2xl overflow-hidden border border-earth-200">
            <div className="bg-gradient-to-r from-forest-600 to-forest-700 p-6">
            ...
            <div className="p-8">
              <div className="grid md:grid-cols-3 gap-6 mb-8">
                <div className="bg-gradient-to-r from-tech-50 to-tech-100 p-6 rounded-xl">
                  <h4 className="text-tech-700 font-semibold mb-2">Credit Score</h4>
                  <div className="text-3xl font-bold text-tech-800">742</div>
                  <div className="text-sm text-tech-600">+12 this month</div>
                </div>
                <div className="bg-gradient-to-r from-forest-50 to-forest-100 p-6 rounded-xl">
                  <h4 className="text-forest-700 font-semibold mb-2">Monthly Profit</h4>
                  <div className="text-3xl font-bold text-forest-800">$3,240</div>
                  <div className="text-sm text-forest-600">+8.5% vs last month</div>
                </div>
                <div className="bg-gradient-to-r from-copper-50 to-copper-100 p-6 rounded-xl">
                  <h4 className="text-copper-700 font-semibold mb-2">Loan Available</h4>
                  <div className="text-3xl font-bold text-copper-800">$12,500</div>
                  <div className="text-sm text-copper-600">Equipment financing</div>
                </div>
              </div>
              <div className="bg-earth-50 p-6 rounded-xl">
                <h4 className="font-semibold text-earth-800 mb-4">Recent Activity</h4>
                <div className="space-y-3">
                  <div className="flex justify-between items-center">
                    <span className="text-earth-700">Gold ore processing - 150kg</span>
                    <span className="text-forest-600 font-medium">+$890</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-earth-700">Equipment maintenance</span>
                    <span className="text-red-600 font-medium">-$120</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-earth-700">Compliance check passed</span>
